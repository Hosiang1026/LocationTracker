...
[![版本号](https://img.shields.io/badge/版本-V2.1.4-blue.svg)](https://github.com/your-repo/LocationTracker/releases)
...
### 基本配置
1. **Webhook URL**: 数据上报的目标地址
   - 支持HTTP和HTTPS
   - 建议使用HTTPS确保数据安全
   - 格式: `https://your-server.com/webhook/endpoint`

2. **上报间隔**: 位置数据上报的时间间隔
   - 范围: 10-10800秒（10秒-3小时）
   - 建议: 60-300秒（1-5分钟）
   - **重要**: 始终使用用户配置的间隔时间
